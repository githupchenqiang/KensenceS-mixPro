...
#define    		V_ZOOM_IMAGE_MIRROR		0x000F
    ...
    //新接口
#define         V_GLOBAL_ALL            0x00FE
#define         V_GLOBAL_INPORT         0x0001
...
int make_pack_5555_pro(unsigned char method, unsigned short cmd, unsigned short cmd_parameter_len, unsigned char* cmd_parameter_data_in, unsigned char * buf_out);
